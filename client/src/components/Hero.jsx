...
const Hero = () => {
  ...
  return (
    // 1. Changed 'inline-flex' to 'flex' to make the background take up full browser width
    <div className='px-4 sm:px-20 xl:px-32 relative flex flex-col w-full justify-center items-center bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      
      <div className='text-center mb-6'>
        <h1 className='text-3xl sm:text-5xl md:text-6xl 2xl:text-7xl font-semibold mx-auto leading-[1.2]'>
          Create amazing contents with <br/> <span className='text-primary'>AI tools</span>
        </h1>
      ...
      {/* 2. Added 'w-full' and 'justify-center' to snap the trust banner exactly to the middle */}
      <div className='flex items-center justify-center gap-4 mt-12 w-full text-gray-600'>
