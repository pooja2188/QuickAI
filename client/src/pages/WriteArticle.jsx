  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        {/* 🛠️ value={input} को जोड़ा गया ताकि इनपुट स्टेट सही से ट्रैक हो */}
        <input
          value={input}
        ...
        <br />
        {/* 🛠️ Tailwind v4 के bg-linear-to-r को स्टैंडर्ड bg-gradient-to-r में बदला गया ताकि यह परफेक्ट दिखे */}
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-150">
        <div className="flex items-center gap-3">
          ...
          {/* 🛠️ हेडिंग को Article Configuration से बदलकर Generated Content किया गया */}
