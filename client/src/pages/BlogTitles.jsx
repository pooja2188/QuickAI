...
const BlogTitles = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // FIXED: Destructured { data } correctly from the raw Axios promise wrapper
      ...
      // FIXED: Modified the validation check to accurately reference response.data
      ...
      <div className="w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96">
        ...
        {!content ? (
          ...
          <div className="mt-3 h-full overflow-y-scroll text-sm text-slate-600">
            <div className="reset-tw content-preview prose max-w-none">
